...
export const AiSvg = ({ className }: { className?: string }) => {
    return (
        <svg className={cn('w-5 h-5', className)} xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
