...
export const DashboardSvg = ({ className }: { className?: string }) => {
    return (
        <svg className={cn('w-5 h-5 ', className)} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
