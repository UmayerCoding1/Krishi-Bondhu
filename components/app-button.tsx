...
export const AppButton = ({ children, className, buttonType = 'primary' }: { children: React.ReactNode, className?: string, buttonType?: "primary" | "secondary" | "outline" }) => {
    return (
        <Button className={cn(
            ...
            buttonType === 'secondary' && 'bg-secondary text-white dark:text-black  hover:bg-secondary/50 dark:hover:bg-secondary/80 flex items-center justify-center font-semibold',
